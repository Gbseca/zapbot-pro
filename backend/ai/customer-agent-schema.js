  ...
  properties: {
    ...
    memory: {
      ...
      properties: {
        ...
        customerType: { type: 'STRING', enum: ['unknown', 'prospect', 'associated'] },
        salesStage: {
          type: 'STRING',
          enum: ['opening', 'discovery', 'education', 'qualification', 'objection', 'ready_for_quote', 'handoff', 'operational', 'closed'],
        },
        primaryNeed: { type: 'STRING' },
        pendingQuestion: { type: 'STRING' },
        lastQuestionAsked: { type: 'STRING' },
